...
const JsConverter = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Error fetching converted code:", err);
      ...
      {!loggedIn ? (
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <TextField
              placeholder="Enter your description or query here"
              type="text"
              multiline
              required
              margin="normal"
          ...
          >
            ...
            >
              {code || "Converted Code Will Appear Here (Please wait for a few seconds after submitting...)"}
            </Typography>
          </Card>
        </Box>
      )}
