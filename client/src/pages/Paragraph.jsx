...
const Paragraph = () => {
  ...
  // Function to generate paragraph using Gemini API
  const handleSubmit = async (e) => {
    e.preventDefault();
    setPara(""); // Reset paragraph
      ...
      {!loggedIn ? (
        ...
        >
          ...
          >
            ...
            >
              {para || "Paragraph Will Appear Here (Please wait for a few seconds after submitting...)"}
            </Typography>
          </Card>
        </Box>
      )}
